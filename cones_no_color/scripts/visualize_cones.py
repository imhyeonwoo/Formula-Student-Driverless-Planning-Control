...
# -*- coding: utf-8 -*-
"""
Visualise /sorted_cones_time (ModifiedFloat32MultiArray) in RViz2.
...
class ConeVisualizer(Node):
    def __init__(self) -> None:
        ...
        # ── parameters ──────────────────────────────────
        self.declare_parameter('topic_name', '/sorted_cones_time')
    ...
    # --------------------------------------------------
    def cb_cones(self, msg: ModifiedFloat32MultiArray) -> None:
        data = msg.data
        n_float = len(data)
        if n_float < 3:
