...
class GlobalYawEstimator(Node):
    def __init__(self):
        ...
        self.pub_raw = self.create_publisher(Float32, 'global_yaw/gps_raw', 10)
        # self.pub_filt = self.create_publisher(Float32, 'global_yaw_only_gps', 10)
        self.pub_filt = self.create_publisher(Float32, 'global_yaw/gps', 10)
